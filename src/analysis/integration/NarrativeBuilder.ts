import type { AnalysisInputData, IntegrationContext } from './IntegrationTypes.js';
...
export class NarrativeBuilder {
  ...
  buildPrimaryRationale(signalResult: any, analyses: AnalysisInputData['analyses']): string {
  ...
  buildSummariesFromPlugins(
    plugins: ReadonlyArray<{ id: string; summarize?: (input: AnalysisInputData, ctx: IntegrationContext) => string }>,
