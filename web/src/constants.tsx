// TODO: Move this into Lui
export const luiColors = {
  fuscous: "#6b6966",
  sea: "#007198",
};
...
export const INVALID_ROUTE_ERROR_MESSAGE = "We don’t recognise that URL, could you please check and try again?";
