import { BinanceProvider } from '../dist/analysis/integration/BinanceProvider.js';
...
const fmt = c => c ? `${c.timestamp.toISOString()} O:${c.open} H:${c.high} L:${c.low} C:${c.close} V:${c.volume}` : 'N/A';
